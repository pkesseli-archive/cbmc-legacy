...
#if (defined(JSA_SYNTHESIS_H_) || defined(JSA_VERIFICATION_H_)) && !defined(JSA_SYNTHESIS_DEBUG_H_)
#define __CPROVER_JSA_DECLARE_INTERNALS
#endif
#endif
...
#ifdef __CPROVER_JSA_DECLARE_INTERNALS
;
#else
{
